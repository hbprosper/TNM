...
*          it must have parameters (S,X,N,F), where X is a REAL array
*          with length S and F is a real array of length N.
...
*  NUMSMS  INTEGER number S-partition of the integers 0,...,MAXORD.
************************************************************************
      EXTERNAL F
...
*     Pullman, Washington 99164-3113  USA
*     Telephone: 509-335-2131 
*     Electronic Mail: genz@gauss.math.wsu.edu
*     Fax: 509-335-1188 
*
****KEYWORDS automatic multidimensional integrator,
*            n-dimensional region (-infin, infin)^n 
